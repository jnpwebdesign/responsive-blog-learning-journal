...
const blogPostObject = [
    {
        ...
        content3: "Viverra ipsum nunc aliquet bibendum enim facilisis. Sed risus ultricies tristique nulla aliquet enim tortor at auctor. Elementum integer enim neque volutpat.",
        heading4: "Nisl rhoncus mattis rhoncus urna",
...
function printBlogFeed() {
    ...
    blogFeed += `
        <div class="blog-post">
            <img class="blog-post-image" data-choose="${blogPostObject[i].title}" src="${blogPostObject[i].image}">
